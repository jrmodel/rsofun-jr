...
settings <- list(
  ...
  #   sampler = "DEzs",
  #   settings = list(
  #     burnin = 500,      # increase this once it's no longer experimental
  ...
  par = list(
    ...
    soilm_par_b = list(lower = 0, upper =5, init = 1.45602286),
    tau_acclim_tempstress = list(lower = 1, upper =30, init = 10),
    par_shape_tempstress  = list(lower =0 ,upper = 1, init = 0.33),
