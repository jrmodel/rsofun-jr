...
p_model_validation = p_model_validation %>%
...
settings <- list(
  ...
  control = list(
    sampler = "DEzs",
    settings = list(
      burnin = 20000,      # increase this once it's no longer experimental
      iterations = 60000  # increase this once it's no longer experimental
    )),
  par = list(
